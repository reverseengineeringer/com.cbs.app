...
public class MediaSessionCompat
{
  ...
  public MediaSessionCompat(Context paramContext, String paramString, ComponentName paramComponentName, PendingIntent paramPendingIntent)
  {
    ...
    if (paramComponentName == null)
    {
      ...
      {
        paramComponentName = (ResolveInfo)((List)localObject).get(0);
    ...
    for (;;)
    {
      ...
      break;
      label232:
      mImpl = new MediaSessionImplBase(paramContext, paramString, (ComponentName)localObject, paramComponentName);
    }
  }
