  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        new StringBuilder("onConnect from service while mState=").append(MediaBrowserCompat.MediaBrowserImplBase.access$700(MediaBrowserCompat.MediaBrowserImplBase.access$600(this$0))).append("... ignoring");
        return;
      }
