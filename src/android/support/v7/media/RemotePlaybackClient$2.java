    ...
    if (paramBundle != null)
    {
      ...
      if (str != null)
      {
        if (RemotePlaybackClient.access$300()) {
          new StringBuilder("Received result from ").append(val$intent.getAction()).append(": data=").append(RemotePlaybackClient.access$400(paramBundle)).append(", sessionId=").append(str).append(", sessionStatus=").append(localMediaSessionStatus);
        }
        try
        {
