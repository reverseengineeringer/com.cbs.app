    ...
    if (paramBundle != null)
    {
      ...
      if ((str1 != null) && (str2 != null) && (localMediaItemStatus != null))
      {
        if (RemotePlaybackClient.access$300()) {
          new StringBuilder("Received result from ").append(val$intent.getAction()).append(": data=").append(RemotePlaybackClient.access$400(paramBundle)).append(", sessionId=").append(str1).append(", sessionStatus=").append(localMediaSessionStatus).append(", itemId=").append(str2).append(", itemStatus=").append(localMediaItemStatus);
        }
