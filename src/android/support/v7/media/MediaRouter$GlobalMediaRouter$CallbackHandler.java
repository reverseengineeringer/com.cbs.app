  ...
  extends Handler
{
  ...
  private void syncWithSystemProvider(int paramInt, Object paramObject)
  {
    ...
    default: 
      return;
    case 257: 
      MediaRouter.GlobalMediaRouter.access$1600(this$0).onSyncRouteAdded((MediaRouter.RouteInfo)paramObject);
      return;
    case 258: 
      MediaRouter.GlobalMediaRouter.access$1600(this$0).onSyncRouteRemoved((MediaRouter.RouteInfo)paramObject);
      return;
    case 259: 
      MediaRouter.GlobalMediaRouter.access$1600(this$0).onSyncRouteChanged((MediaRouter.RouteInfo)paramObject);
      return;
    }
    MediaRouter.GlobalMediaRouter.access$1600(this$0).onSyncRouteSelected((MediaRouter.RouteInfo)paramObject);
  }
  ...
  public final void handleMessage(Message paramMessage)
  {
    ...
    try
    {
      int i = MediaRouter.GlobalMediaRouter.access$1500(this$0).size();
      for (;;)
      {
        i -= 1;
        if (i < 0) {
        ...
        MediaRouter localMediaRouter = (MediaRouter)((WeakReference)MediaRouter.GlobalMediaRouter.access$1500(this$0).get(i)).get();
        if (localMediaRouter == null) {
          MediaRouter.GlobalMediaRouter.access$1500(this$0).remove(i);
        } else {
