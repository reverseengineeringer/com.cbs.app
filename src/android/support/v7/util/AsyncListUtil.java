...
public class AsyncListUtil<T>
{
  ...
  private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback()
  {
    ...
    {
      new StringBuilder("[BKGR] ").append(String.format(paramAnonymousString, paramAnonymousVarArgs));
    }
  ...
  {
    new StringBuilder("[MAIN] ").append(String.format(paramString, paramVarArgs));
  }
