  ...
  extends MenuInflater
{
  ...
  public void inflate(int paramInt, Menu paramMenu)
  {
    ...
    //   26: invokevirtual 177	android/content/Context:getResources	()Landroid/content/res/Resources;
    //   29: iload_1
    //   30: invokevirtual 183	android/content/res/Resources:getLayout	(I)Landroid/content/res/XmlResourceParser;
    //   33: astore 6
    //   35: aload 6
    //   37: astore 4
    //   39: aload 6
    ...
    //   47: aload 6
    //   49: aload 6
    //   51: invokestatic 189	android/util/Xml:asAttributeSet	(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/AttributeSet;
    //   54: aload_2
    //   55: invokespecial 142	android/support/v7/view/SupportMenuInflater:parseMenu	(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/Menu;)V
    //   58: aload 6
    //   60: ifnull -47 -> 13
    //   63: aload 6
    ...
    //   72: aload 4
    //   74: astore_3
    //   75: new 196	android/view/InflateException
    //   78: dup
    //   79: ldc -58
    //   81: aload_2
    //   82: invokespecial 201	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   85: athrow
    //   86: astore_2
    //   87: aload_3
    //   88: ifnull +9 -> 97
    ...
    //   100: aload 5
    //   102: astore_3
    //   103: new 196	android/view/InflateException
    //   106: dup
    //   107: ldc -58
    //   109: aload_2
    //   110: invokespecial 201	android/view/InflateException:<init>	(Ljava/lang/String;Ljava/lang/Throwable;)V
    //   113: athrow
  ...
  private class MenuState
  {
    ...
    private <T> T newInstance(String paramString, Class<?>[] paramArrayOfClass, Object[] paramArrayOfObject)
    {
      try
      {
        paramString = mContext.getClassLoader().loadClass(paramString).getConstructor(paramArrayOfClass);
