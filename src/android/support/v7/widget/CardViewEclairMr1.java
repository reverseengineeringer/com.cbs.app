    ...
    RoundRectDrawableWithShadow.sRoundRectHelper = new RoundRectDrawableWithShadow.RoundRectHelper()
    {
      public void drawRoundRect(Canvas paramAnonymousCanvas, RectF paramAnonymousRectF, float paramAnonymousFloat, Paint paramAnonymousPaint)
      {
        ...
        if (paramAnonymousFloat >= 1.0F)
        {
          ...
          paramAnonymousCanvas.drawRect(left + f1 - 1.0F, top, right - f1 + 1.0F, top + f1, paramAnonymousPaint);
          paramAnonymousCanvas.drawRect(left + f1 - 1.0F, bottom - f1 + 1.0F, right - f1 + 1.0F, bottom, paramAnonymousPaint);
        }
        paramAnonymousFloat = left;
        f2 = top;
        paramAnonymousCanvas.drawRect(paramAnonymousFloat, Math.max(0.0F, f1 - 1.0F) + f2, right, bottom - f1 + 1.0F, paramAnonymousPaint);
      }
    };
  }
