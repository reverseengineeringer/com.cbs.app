...
public final class AppCompatDrawableManager
{
  ...
  public final void addDelegate(InflateDelegate paramInflateDelegate)
  {
    if (mDelegates == null) {
  ...
  public final void removeDelegate(InflateDelegate paramInflateDelegate)
  {
    if (mDelegates != null) {
  ...
  public final boolean tintDrawableUsingColorFilter(Context paramContext, int paramInt, Drawable paramDrawable)
  {
  ...
  {
    public abstract Drawable onInflateDrawable(Context paramContext, int paramInt);
  }
}
