...
public abstract class RecyclerView$LayoutManager
{
  ...
  private void scrapOrRecycleView(RecyclerView.Recycler paramRecycler, int paramInt, View paramView)
  {
    ...
    if ((localViewHolder.isInvalid()) && (!localViewHolder.isRemoved()) && (!RecyclerView.access$2900(mRecyclerView).hasStableIds()))
    {
  ...
  {
    return (mRecyclerView != null) && (RecyclerView.access$5200(mRecyclerView));
  }
  
  public int getColumnCountForAccessibility(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    if ((mRecyclerView == null) || (RecyclerView.access$2900(mRecyclerView) == null)) {}
    while (!canScrollHorizontally()) {
      return 1;
    }
    return RecyclerView.access$2900(mRecyclerView).getItemCount();
  }
  ...
  public void onInitializeAccessibilityEvent(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    for (bool1 = bool2;; bool1 = false)
    {
      ...
      if (RecyclerView.access$2900(mRecyclerView) == null) {
        break;
      }
      paramRecycler.setItemCount(RecyclerView.access$2900(mRecyclerView).getItemCount());
      return;
    }
  }
  ...
  {
    RecyclerView.access$5300(mRecyclerView, paramInt1, paramInt2);
  }
  ...
  {
    RecyclerView.access$5400(mRecyclerView, paramInt1, paramInt2);
  }
