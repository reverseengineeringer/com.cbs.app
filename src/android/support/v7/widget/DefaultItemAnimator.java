  ...
  extends SimpleItemAnimator
{
  ...
  private void animateChangeImpl(final ChangeInfo paramChangeInfo)
  {
    ...
    final Object localObject = oldHolder;
    if (localObject == null) {}
    for (localObject = null;; localObject = itemView)
    {
      ...
      if (localObject != null)
      {
        ...
        ((ViewPropertyAnimatorCompat)localObject).alpha(0.0F).setListener(new VpaListenerAdapter(paramChangeInfo)
        {
          public void onAnimationEnd(View paramAnonymousView)
          {
      ...
      if (localView != null)
      {
        ...
        ((ViewPropertyAnimatorCompat)localObject).translationX(0.0F).translationY(0.0F).setDuration(getChangeDuration()).alpha(1.0F).setListener(new VpaListenerAdapter(paramChangeInfo)
        {
          public void onAnimationEnd(View paramAnonymousView)
          {
            localObject.setListener(null);
