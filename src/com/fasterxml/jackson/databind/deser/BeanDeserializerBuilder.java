...
public class BeanDeserializerBuilder
{
  ...
  public JsonDeserializer<?> build()
  {
    ...
    BeanPropertyMap localBeanPropertyMap = new BeanPropertyMap((Collection)localObject, _caseInsensitivePropertyComparison);
  ...
  public JsonDeserializer<?> buildBuilderBased(JavaType paramJavaType, String paramString)
  {
    ...
    paramString = new BeanPropertyMap(paramJavaType, _caseInsensitivePropertyComparison);
