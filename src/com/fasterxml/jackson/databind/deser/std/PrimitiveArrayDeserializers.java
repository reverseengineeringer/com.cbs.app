    ...
    extends PrimitiveArrayDeserializers<byte[]>
  {
    ...
    public final byte[] deserialize(JsonParser paramJsonParser, DeserializationContext paramDeserializationContext)
    {
      ...
      for (;;)
      {
        ...
        {
          throw JsonMappingException.wrapWithPath(paramJsonParser, localObject1, j + localByteBuilder.bufferedSize());
        }
        throw paramDeserializationContext.mappingException(_valueClass.getComponentType());
        int i = 0;
        continue;
    ...
    extends PrimitiveArrayDeserializers<short[]>
  {
    ...
    public final short[] deserialize(JsonParser paramJsonParser, DeserializationContext paramDeserializationContext)
    {
      ...
      for (;;)
      {
        ...
        {
          throw JsonMappingException.wrapWithPath(paramJsonParser, localObject, j + localShortBuilder.bufferedSize());
        }
      }
    }
  }
