  ...
  extends DateFormat
{
  ...
  protected Date parseAsISO8601(String paramString, ParsePosition paramParsePosition)
  {
    ...
    if ((i <= 10) && (Character.isDigit(c)))
    {
      ...
      {
        localObject1 = _cloneFormat(DATE_FORMAT_PLAIN, "yyyy-MM-dd", _timezone, _locale);
    ...
    for (;;)
    {
      ...
      {
        localObject2 = _cloneFormat(DATE_FORMAT_ISO8601_Z, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", _timezone, _locale);
    ...
    if (hasTimeZone(paramString))
    {
      ...
      for (;;)
      {
        ...
        localObject1 = _cloneFormat(DATE_FORMAT_ISO8601, "yyyy-MM-dd'T'HH:mm:ss.SSSZ", _timezone, _locale);
    ...
    for (;;)
    {
      ...
      localObject1 = _cloneFormat(DATE_FORMAT_ISO8601_Z, "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'", _timezone, _locale);
  ...
  {
    if (!paramTimeZone.equals(_timezone))
    {
      _formatRFC1123 = null;
      _formatISO8601 = null;
  ...
  public String toString()
  {
    ...
    return str1 + "(locale: " + _locale + ")";
  }
  
  public StdDateFormat withLocale(Locale paramLocale)
  {
    if (paramLocale.equals(_locale)) {
      return this;
    }
    return new StdDateFormat(_timezone, paramLocale);
  }
  ...
  public StdDateFormat withTimeZone(TimeZone paramTimeZone)
  {
    ...
    if (localTimeZone.equals(_timezone)) {
      return this;
    }
    return new StdDateFormat(localTimeZone, _locale);
  }
}
