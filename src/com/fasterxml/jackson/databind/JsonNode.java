...
public abstract class JsonNode
  implements TreeNode, JsonSerializable, Iterable<JsonNode>
{
  ...
  {
    JsonPointer localJsonPointer = paramJsonPointer;
    ...
    for (;;)
    {
      ...
      paramJsonPointer = paramJsonPointer._at(localJsonPointer);
      if (paramJsonPointer == null) {
        return MissingNode.getInstance();
      }
      localJsonPointer = localJsonPointer.tail();
    }
  }
