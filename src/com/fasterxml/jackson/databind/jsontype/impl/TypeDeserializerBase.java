    ...
    synchronized (_deserializers)
    {
      ...
      if (localObject2 == null)
      {
        ...
        if (localObject2 == null)
        {
          ...
          if (localObject2 == null) {
            localObject1 = _handleUnknownTypeId(paramDeserializationContext, paramString, _idResolver, _baseType);
          }
      ...
      localObject1 = paramDeserializationContext.findContextualValueDeserializer((JavaType)localObject1, _property);
    }
  }
