  ...
  implements Serializable
{
  ...
  {
    return JsonMappingException.from(_parser, "Can not deserialize instance of " + _calcName(paramClass) + " out of " + paramJsonToken + " token");
  }
  ...
  {
    return (T)findContextualValueDeserializer(paramJavaType, paramBeanProperty).deserialize(paramJsonParser, this);
  }
  ...
  {
    return (T)findRootValueDeserializer(paramJavaType).deserialize(paramJsonParser, this);
  }
