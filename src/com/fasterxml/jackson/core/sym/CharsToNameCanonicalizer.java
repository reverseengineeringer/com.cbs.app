...
public final class CharsToNameCanonicalizer
{
  ...
  private void rehash()
  {
    ...
    throw new Error("Internal error on SymbolTable.rehash(): had " + _size + " entries; now have " + m + ".");
  }
  ...
  static final class Bucket
  {
    ...
    public final String has(char[] paramArrayOfChar, int paramInt1, int paramInt2)
    {
      ...
      do
      {
        if (symbol.charAt(i) != paramArrayOfChar[(paramInt1 + i)]) {
          return null;
        }
        j = i + 1;
        i = j;
