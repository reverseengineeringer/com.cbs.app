...
final class o
  extends TimerTask
{
  o(StreamSenseVideoView paramStreamSenseVideoView, long paramLong, HashMap paramHashMap) {}
  
  public final void run()
  {
    b.a("StreamSenseVideoView", "startEventTimer -> lastPosition:" + a + " currentPosition:" + StreamSenseVideoView.a(c));
    ...
    if (l2 >= 500L)
    {
      ...
      if (l2 > 0L)
      {
        ...
        b.a("StreamSenseVideoView", "addToBufferingTotal=" + l2);
...
/* Location:
 * Qualified Name:     com.comscore.streaming.o
