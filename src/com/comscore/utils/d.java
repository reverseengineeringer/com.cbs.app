...
public final class d
{
  ...
  {
    if ((j.a(paramContext, "android.permission.ACCESS_WIFI_STATE").booleanValue()) && (((ConnectivityManager)paramContext.getSystemService("connectivity")).getNetworkInfo(1).isConnected()))
    {
  ...
  {
    if (j.a(paramContext, "android.permission.ACCESS_NETWORK_STATE").booleanValue())
    {
  ...
  private static HttpClient c()
  {
    ...
    {
      b.b("comScore", localException.getMessage());
    }
  ...
  {
    if ((j.a(paramContext, "android.permission.ACCESS_NETWORK_STATE").booleanValue()) && (Build.VERSION.SDK_INT >= 13))
    {
  ...
  {
    if (j.a(paramContext, "android.permission.READ_PHONE_STATE").booleanValue())
    {
