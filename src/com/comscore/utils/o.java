...
public final class o
{
  ...
  public static String a(String[] paramArrayOfString, String paramString)
  {
    try
    {
      ...
      paramArrayOfString = n.a(a.toString()).toLowerCase();
      int i = localStringBuilder.indexOf("md5=\"");
      localStringBuilder.insert("md5=\"".length() + i, paramArrayOfString);
  ...
  private static void a(StringBuilder paramStringBuilder, String paramString1, String paramString2)
  {
    ...
    while (i < d.length)
    {
      ...
      b(paramString1, str);
      if ((b != -1) && (c > b)) {
        paramStringBuilder.append(str).append("=\"").append(paramString1, b, c).append("\" ");
      }
      i += 1;
    }
