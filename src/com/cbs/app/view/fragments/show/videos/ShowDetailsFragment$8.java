...
final class ShowDetailsFragment$8
  implements ResponseModelListener
{
  ShowDetailsFragment$8(ShowDetailsFragment paramShowDetailsFragment) {}
  ...
  public final void a(ResponseModel paramResponseModel)
  {
    ...
    if ((paramResponseModel instanceof UpsellEndpointResponse))
    {
      ...
      if ((paramResponseModel != null) && (paramResponseModel.size() > 0))
      {
        ...
        a.g = paramResponseModel.getCallToAction();
        ShowDetailsFragment.a(a, paramResponseModel);
      }
    }
  }
}
...
/* Location:
 * Qualified Name:     com.cbs.app.view.fragments.show.videos.ShowDetailsFragment.8
