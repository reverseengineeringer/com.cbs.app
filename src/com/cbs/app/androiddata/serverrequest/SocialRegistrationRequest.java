  ...
  extends BaseServerRequest
{
  ...
  {
    return SocialRegistrationEndpointResponse.class;
  }
  ...
  {
    return e + "/apps-api/v3.0/" + d + "/social/registration.json";
  }
}

/* Location:
 * Qualified Name:     com.cbs.app.androiddata.serverrequest.SocialRegistrationRequest
