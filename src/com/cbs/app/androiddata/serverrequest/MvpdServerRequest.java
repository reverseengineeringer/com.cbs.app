...
public class MvpdServerRequest
  extends BaseServerRequest
{
  ...
  {
    return MvpdEndpointResponse.class;
  }
  ...
  {
    return e + "/apps-api/v3.0/" + d + "/mvpd/adobe/shortMediaToken.json";
  }
}

/* Location:
 * Qualified Name:     com.cbs.app.androiddata.serverrequest.MvpdServerRequest
