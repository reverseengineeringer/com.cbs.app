...
public class RemoveMyShowServerRequest
  extends BaseServerRequest
{
  ...
  {
    return e + "/apps-api/" + d + "/lists/favoriteshows/unique/" + (String)b.get("uniqueName") + "/item/delete.json";
  }
}

/* Location:
 * Qualified Name:     com.cbs.app.androiddata.serverrequest.RemoveMyShowServerRequest
