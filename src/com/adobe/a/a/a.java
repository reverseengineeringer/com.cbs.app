...
public final class a
{
  ...
  public static void a(HashMap<String, Object> paramHashMap)
  {
    ...
    {
      c("Audience Manager - Configure has not been called", new Object[0]);
      return;
    }
    new Thread(new b(paramHashMap, null)).start();
  }
  ...
  private static String b()
  {
    if (i)
    {
      ...
      {
        m = false;
        l = a.getSharedPreferences("APP_MEASUREMENT_CACHE", 0);
      }
      e = l.getString("AAMUserId", null);
    }
    return e;
  }
  ...
  private static String b(String paramString)
  {
    ...
    try
    {
      ...
      while (i1 < i2)
      {
        localStringBuilder.append(p[(paramString[i1] & 0xFF)]);
        i1 += 1;
      }
    ...
    {
      c("UnsupportedEncodingException : " + paramString.getMessage(), new Object[0]);
    }
    return null;
  }
  ...
  private static SharedPreferences.Editor c()
  {
    ...
    {
      o = false;
      n = a.getSharedPreferences("APP_MEASUREMENT_CACHE", 0).edit();
    }
    return n;
  }
  
  private static void c(String paramString, Object... paramVarArgs)
  {
    String.format("ADBMobile Error : " + paramString, paramVarArgs);
  }
  
  private static String d(HashMap<String, Object> paramHashMap)
  {
    ...
    while (paramHashMap.hasNext())
    {
      ...
      if ((str != null) && (str.length() > 0) && (localObject != null) && (localObject.toString().length() > 0)) {
        localStringBuilder.append("&c_").append(b(str.replace(".", "_"))).append("=").append(b(localObject.toString()));
      }
    }
    ...
    implements Runnable
  {
    ...
    public b(HashMap<String, Object> paramHashMap, a.a<HashMap> parama)
    {
      a = paramHashMap;
      b = null;
    }
...
/* Location:
 * Qualified Name:     com.adobe.a.a.a
