  ...
  extends Button
{
  ...
  protected FacebookButtonBase(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2, String paramString)
  {
    ...
    for (;;)
    {
      ...
      analyticsButtonCreatedEventName = paramString;
      return;
    }
  }
  ...
  private void parseTextAttributes(Context paramContext, AttributeSet paramAttributeSet, int paramInt1, int paramInt2)
  {
    ...
    //   24: iconst_0
    //   25: iconst_m1
    //   26: invokevirtual 97	android/content/res/TypedArray:getColor	(II)I
    //   29: invokevirtual 134	com/facebook/FacebookButtonBase:setTextColor	(I)V
    //   32: aload 5
    //   34: invokevirtual 94	android/content/res/TypedArray:recycle	()V
    //   37: aload_1
    ...
    //   61: iconst_0
    //   62: bipush 17
    //   64: invokevirtual 138	android/content/res/TypedArray:getInt	(II)I
    //   67: invokevirtual 141	com/facebook/FacebookButtonBase:setGravity	(I)V
    //   70: aload 5
    //   72: invokevirtual 94	android/content/res/TypedArray:recycle	()V
    //   75: aload_1
    ...
    //   108: iconst_0
    //   109: iconst_0
    //   110: invokevirtual 118	android/content/res/TypedArray:getDimensionPixelSize	(II)I
    //   113: i2f
    //   114: invokevirtual 148	com/facebook/FacebookButtonBase:setTextSize	(IF)V
    //   117: aload_0
    //   118: aload_1
    //   119: iconst_1
    //   120: iconst_1
    //   121: invokevirtual 138	android/content/res/TypedArray:getInt	(II)I
    //   124: invokestatic 154	android/graphics/Typeface:defaultFromStyle	(I)Landroid/graphics/Typeface;
    //   127: invokevirtual 158	com/facebook/FacebookButtonBase:setTypeface	(Landroid/graphics/Typeface;)V
    //   130: aload_0
    //   131: aload_1
    //   132: iconst_2
    //   133: invokevirtual 162	android/content/res/TypedArray:getString	(I)Ljava/lang/String;
    //   136: invokevirtual 166	com/facebook/FacebookButtonBase:setText	(Ljava/lang/CharSequence;)V
    //   139: aload_1
    //   140: invokevirtual 94	android/content/res/TypedArray:recycle	()V
    //   143: return
    //   144: astore_1
    //   145: aload 5
    //   147: invokevirtual 94	android/content/res/TypedArray:recycle	()V
    //   150: aload_1
    //   151: athrow
    //   152: astore_1
    //   153: aload 5
    //   155: invokevirtual 94	android/content/res/TypedArray:recycle	()V
    //   158: aload_1
    //   159: athrow
    //   160: astore_2
    //   161: aload_1
    //   162: invokevirtual 94	android/content/res/TypedArray:recycle	()V
    //   165: aload_2
    //   166: athrow
