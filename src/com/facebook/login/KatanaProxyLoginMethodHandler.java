  ...
  extends LoginMethodHandler
{
  ...
  private LoginClient.Result handleResultOk(LoginClient.Request paramRequest, Intent paramIntent)
  {
    ...
    if ((paramIntent == null) && (str2 == null) && (localObject == null)) {
      try
      {
        paramIntent = LoginClient.Result.createTokenResult(paramRequest, createAccessTokenFromWebBundle(paramRequest.getPermissions(), localBundle, AccessTokenSource.FACEBOOK_APPLICATION_WEB, paramRequest.getApplicationId()));
        return paramIntent;
      }
