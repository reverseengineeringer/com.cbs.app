...
public class TestUserManager
{
  ...
  private AccessToken getAccessTokenForUser(List<String> paramList, Mode paramMode, String paramString)
  {
    ...
    for (;;)
    {
      ...
      for (paramMode = createTestAccount(paramList, paramMode, paramString);; paramMode = findOrCreateSharedTestAccount(paramList, paramMode, paramString)) {
        return new AccessToken(paramMode.optString("access_token"), testApplicationId, paramMode.optString("id"), paramList, null, AccessTokenSource.TEST_USER, null, null);
      }
    }
  }
