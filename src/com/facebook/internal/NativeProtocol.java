...
public final class NativeProtocol
{
  ...
  private static TreeSet<Integer> fetchAllAvailableProtocolVersionsForAppInfo(NativeAppInfo paramNativeAppInfo)
  {
    ...
    //   0: aconst_null
    //   1: astore_2
    //   2: new 378	java/util/TreeSet
    //   5: dup
    //   6: invokespecial 532	java/util/TreeSet:<init>	()V
    //   9: astore_3
    //   10: invokestatic 538	com/facebook/FacebookSdk:getApplicationContext	()Landroid/content/Context;
    //   13: invokevirtual 544	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   16: astore_1
    //   17: aload_0
    //   18: invokestatic 546	com/facebook/internal/NativeProtocol:buildPlatformProviderVersionURI	(Lcom/facebook/internal/NativeProtocol$NativeAppInfo;)Landroid/net/Uri;
    //   21: astore 4
    //   23: invokestatic 538	com/facebook/FacebookSdk:getApplicationContext	()Landroid/content/Context;
    //   26: invokevirtual 550	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   29: new 354	java/lang/StringBuilder
    //   32: dup
    //   33: invokespecial 551	java/lang/StringBuilder:<init>	()V
    //   36: aload_0
    //   37: invokevirtual 361	com/facebook/internal/NativeProtocol$NativeAppInfo:getPackage	()Ljava/lang/String;
    //   40: invokevirtual 365	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   43: ldc -57
    //   45: invokevirtual 365	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   48: invokevirtual 368	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   51: iconst_0
    //   52: invokevirtual 557	android/content/pm/PackageManager:resolveContentProvider	(Ljava/lang/String;I)Landroid/content/pm/ProviderInfo;
    //   55: ifnull +77 -> 132
    //   58: aload_1
    //   59: aload 4
    //   61: iconst_1
    //   62: anewarray 559	java/lang/String
    //   65: dup
    //   66: iconst_0
    //   67: ldc -51
    //   69: aastore
    ...
    //   71: aconst_null
    //   72: aconst_null
    //   73: invokevirtual 565	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   76: astore_0
    //   77: aload_0
    //   78: astore_1
    //   79: aload_0
    ...
    //   84: astore_1
    //   85: aload_0
    //   86: invokeinterface 570 1 0
    //   91: ifeq +43 -> 134
    //   94: aload_3
    //   95: aload_0
    //   96: aload_0
    //   97: ldc -51
    //   99: invokeinterface 574 2 0
    //   104: invokeinterface 578 2 0
    //   109: invokestatic 307	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   112: invokevirtual 579	java/util/TreeSet:add	(Ljava/lang/Object;)Z
    //   115: pop
    //   116: goto -33 -> 83
    //   119: astore_1
    //   120: aload_0
    ...
    //   0	152	0	paramNativeAppInfo	NativeAppInfo
    //   16	69	1	localObject1	Object
    //   119	12	1	localObject2	Object
    //   133	6	1	localObject3	Object
    //   146	1	1	localObject4	Object
    //   1	147	2	localObject5	Object
    //   9	136	3	localTreeSet	TreeSet
    //   21	39	4	localUri	Uri
    // Exception table:
    //   from	to	target	type
    //   85	116	119	finally
    //   23	77	146	finally
