  ...
  extends ResultProcessor
{
  ...
  public void onSuccess(AppCall paramAppCall, Bundle paramBundle)
  {
    ...
    Object localObject1 = LikeActionController.access$700(this$0);
    String str1 = LikeActionController.access$800(this$0);
    if (paramBundle.containsKey("like_count_string"))
    {
      str1 = paramBundle.getString("like_count_string");
      localObject1 = str1;
    }
    Object localObject2 = LikeActionController.access$900(this$0);
    String str2 = LikeActionController.access$1000(this$0);
    ...
    for (Bundle localBundle = new Bundle();; localBundle = val$analyticsParameters)
    {
      ...
      LikeActionController.access$1300(this$0, bool, (String)localObject1, str1, (String)localObject2, str2, paramBundle);
      return;
