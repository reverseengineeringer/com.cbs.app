...
public class GraphResponse
{
  ...
  static List<GraphResponse> fromHttpConnection(HttpURLConnection paramHttpURLConnection, GraphRequestBatch paramGraphRequestBatch)
  {
    ...
    //   31: astore_3
    //   32: aload_0
    //   33: invokevirtual 174	java/net/HttpURLConnection:getResponseCode	()I
    //   36: sipush 400
    //   39: if_icmplt +55 -> 94
    //   42: aload_2
    //   43: astore 4
    ...
    //   59: astore_3
    //   60: aload_0
    //   61: invokevirtual 252	java/net/HttpURLConnection:getErrorStream	()Ljava/io/InputStream;
    //   64: astore_2
    //   65: aload_2
    //   66: astore 4
    //   68: aload_2
    ...
    //   80: aload_0
    //   81: aload_1
    //   82: invokestatic 254	com/facebook/GraphResponse:createResponsesFromStream	(Ljava/io/InputStream;Ljava/net/HttpURLConnection;Lcom/facebook/GraphRequestBatch;)Ljava/util/List;
    //   85: astore 8
    //   87: aload_2
    //   88: invokestatic 258	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   91: aload 8
    //   93: areturn
    //   94: aload_2
    //   95: astore 4
    ...
    //   111: astore_3
    //   112: aload_0
    //   113: invokevirtual 261	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   116: astore_2
    //   117: goto -52 -> 65
    //   120: astore_2
    //   121: aload 4
    //   123: astore_3
    //   124: getstatic 236	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   127: ldc 20
    //   129: ldc_w 263
    //   132: iconst_1
    ...
    //   138: aload_2
    //   139: aastore
    //   140: invokestatic 219	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   143: aload 4
    //   145: astore_3
    //   146: aload_1
    //   147: aload_0
    //   148: aload_2
    //   149: invokestatic 265	com/facebook/GraphResponse:constructErrorResponses	(Ljava/util/List;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookException;)Ljava/util/List;
    //   152: astore_0
    //   153: aload 4
    //   155: invokestatic 258	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   158: aload_0
    //   159: areturn
    //   160: astore_2
    //   161: aload 5
    //   163: astore_3
    //   164: getstatic 236	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   167: ldc 20
    //   169: ldc_w 263
    //   172: iconst_1
    ...
    //   178: aload_2
    //   179: aastore
    //   180: invokestatic 219	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   183: aload 5
    //   185: astore_3
    //   186: aload_1
    //   187: aload_0
    //   188: new 136	com/facebook/FacebookException
    //   191: dup
    //   192: aload_2
    //   193: invokespecial 268	com/facebook/FacebookException:<init>	(Ljava/lang/Throwable;)V
    //   196: invokestatic 265	com/facebook/GraphResponse:constructErrorResponses	(Ljava/util/List;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookException;)Ljava/util/List;
    //   199: astore_0
    //   200: aload 5
    //   202: invokestatic 258	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   205: aload_0
    //   206: areturn
    //   207: astore_2
    //   208: aload 6
    //   210: astore_3
    //   211: getstatic 236	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   214: ldc 20
    //   216: ldc_w 263
    //   219: iconst_1
    ...
    //   225: aload_2
    //   226: aastore
    //   227: invokestatic 219	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   230: aload 6
    //   232: astore_3
    //   233: aload_1
    //   234: aload_0
    //   235: new 136	com/facebook/FacebookException
    //   238: dup
    //   239: aload_2
    //   240: invokespecial 268	com/facebook/FacebookException:<init>	(Ljava/lang/Throwable;)V
    //   243: invokestatic 265	com/facebook/GraphResponse:constructErrorResponses	(Ljava/util/List;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookException;)Ljava/util/List;
    //   246: astore_0
    //   247: aload 6
    //   249: invokestatic 258	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   252: aload_0
    //   253: areturn
    //   254: astore_2
    //   255: aload 7
    //   257: astore_3
    //   258: getstatic 236	com/facebook/LoggingBehavior:REQUESTS	Lcom/facebook/LoggingBehavior;
    //   261: ldc 20
    //   263: ldc_w 263
    //   266: iconst_1
    ...
    //   272: aload_2
    //   273: aastore
    //   274: invokestatic 219	com/facebook/internal/Logger:log	(Lcom/facebook/LoggingBehavior;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   277: aload 7
    //   279: astore_3
    //   280: aload_1
    //   281: aload_0
    //   282: new 136	com/facebook/FacebookException
    //   285: dup
    //   286: aload_2
    //   287: invokespecial 268	com/facebook/FacebookException:<init>	(Ljava/lang/Throwable;)V
    //   290: invokestatic 265	com/facebook/GraphResponse:constructErrorResponses	(Ljava/util/List;Ljava/net/HttpURLConnection;Lcom/facebook/FacebookException;)Ljava/util/List;
    //   293: astore_0
    //   294: aload 7
    //   296: invokestatic 258	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   299: aload_0
    //   300: areturn
    //   301: astore_0
    //   302: aload_3
    //   303: invokestatic 258	com/facebook/internal/Utility:closeQuietly	(Ljava/io/Closeable;)V
    //   306: aload_0
    //   307: athrow
